...
public class Billing {
	...
	private static String customerFilePath = "Billing.customersFile";
	private static String invoiceFilePath = "Billing.invoicesFile";
	...
	public Billing(Configuration configuration) {
		this(configuration.getString(customerFilePath), configuration.getString(invoiceFilePath));
	}

	public Billing() {
		this(ComponentConfigurationManager.getInstance()
