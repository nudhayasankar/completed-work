...
public class Reporter {
	...
	private static String billingConfig = "Billing";
	private static String output = "Billing.output";
	private static String asOfDate = "Billing.asOfDate";
	...
	public Reporter(Billing billing, Configuration config) {
		this(billing, config.getString(output), LocalDate.parse(config.getString(asOfDate)));
	}

	public Reporter() {
		this(new Billing(), ComponentConfigurationManager.getInstance()
				.getConfiguration(billingConfig));
	}
